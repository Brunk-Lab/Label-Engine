...
from engine.core.data.datasets import ecDNADataset
from engine.core.utils.serialization import load_model
...
def get_dataset(dataset_name, cfg):
    if dataset_name == 'ecDNA':
        dataset = ecDNADataset(cfg.ECDNA_PATH)
    else:
        dataset = None
